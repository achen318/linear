...
print(
    "You can avoid this confusion by passing np.array a list object rather than a list:\n"
)
print(
    "Notice that, by default, NumPy interprets C = np.array([[0,1,2,3,4,5,6.0]]) to have shape ",
    C.shape,
)
